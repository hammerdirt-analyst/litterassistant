# text for the data presentation tab
data_tab_en1 = "The most common objects in a report were selected using two criteria:\n\n* Qauntity ie. the ten most " \
               "abundant.\n* The fail rate: The chance that at least one of the object type will be found in a sample"

data_tab_en2 = "A surveyor is likely to encounter common objects in the various states of fragmentation or " \
               "decomposition. Objects that are easy to identify or to describe have a better chance a being placed " \
               "under the correct object code. For example a cigarette end is immediately recognizable. Fragmented or " \
               "otherwise degraded objests are challenging, determining wether or not a plastic bottle cap comes from " \
               "a beverage or a chemical container can be difficult when all the labeling is removed or eroded." \

data_tab_en3 = "In this report the different fragmented plastics, foams and plastic bottle caps have been " \
                   "combined into composite groups. The operation is summarized accordingly:\n\n* __Gfoam:__ " \
                   "Fragmented expanded polystyrene, object-codes: G81, G82, G83\n* __Gfrags:__ Fragmented plastics, " \
                   "object-codes: G78, G79, G80, G75, G76, G77\n * __Gcaps:__ Plastic bottle lids and lid rings, " \
...
data_tab_fr2 = "Un enquêteur est susceptible de rencontrer des objets courants dans divers états de fragmentation ou de décomposition. Les objets faciles à identifier ou à décrire ont plus de chances d'être placés sous le bon code d'objet. Par exemple, un mégot de cigarette est immédiatement reconnaissable. Les objets fragmentés ou dégradés de toute autre manière sont difficiles, déterminer si un bouchon de bouteille en plastique provient d'une boisson ou d'un contenant chimique peut être difficile lorsque tout l'étiquetage est enlevé ou érodé."
...
tab_de = [data_tab_de1, data_tab_de2, data_tab_de3, data_tab_de4]
